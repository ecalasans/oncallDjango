...
SECRET_KEY = '@tv=rzznqrlef(!#84^bmm820c-l3&6#kf!xtm(^43y@=8c&*q'
...
EMAIL_HOST = "pass.redcaprn.org"
EMAIL_PORT = 587
EMAIL_USE_SSL = False
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "admin@pass.redcaprn.org"
EMAIL_HOST_PASSWORD = "PassRedcaprn123@"
